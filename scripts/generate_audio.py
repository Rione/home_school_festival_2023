...
audio.tts("赤、白、黄色、茶色、どの色の紙袋をお持ちしましょうか。", mode="gen", path=PREFIX + "ask_color.mp3")
audio.tts("しろ色の紙袋をお持ちします。", mode="gen", path=PREFIX + "info_white.mp3")
audio.tts("茶色の紙袋をお持ちします。", mode="gen", path=PREFIX + "info_brown.mp3")
audio.tts("黄色の紙袋をお持ちします。", mode="gen", path=PREFIX + "info_yellow.mp3")
audio.tts("赤色の紙袋をお持ちします。", mode="gen", path=PREFIX + "info_red.mp3")
...
audio.tts("1番目の地点へ移動します。", mode="gen", path=PREFIX + "info_target1.mp3")
audio.tts("2番目の地点へ移動します。", mode="gen", path=PREFIX + "info_target2.mp3")
